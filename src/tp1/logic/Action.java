...
public enum Action {
	...
	public static Action parseAction(String[] objDescription) {//Se llama a este método desde el parse de MovingObject.
		String strAction = objDescription[2].toUpperCase();//Coge la acción introducida por el usuario y la convierte a myúsuclas
	...
	//Como Goomba tan solo puede ser creado con act = right o left y el Mario act = right, left o stop, tan sólo manejamos esas acciones.
	//(Up se queda fuera).
}
